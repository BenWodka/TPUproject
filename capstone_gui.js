...
function info_screen() {
  loadScreen("info_screen.html", function () {
    ...
    if (canvas) {
      ...
      // const color_gradient = ctx.createRadialGradient(
      //   325,
      //   400,
      //   450,
      //   325,
      ...
      ctx.fillText("Make a Selection", (ctx.canvas.width / 2) - 150, 40);
  ...
  loadScreen("create_new_process.html", function () {
    ...
    if (canvas) {
      ...
      ctx.fillRect(
        row_x1_start,
        row_y1_start,
        x_width + row_x1_start,
        y_width + row_y1_start
      );
      ctx.fillStyle = "black";
      ctx.fillText(
        "Bucket 1:",
        row_x1_start + title_indent,
        row_y1_start + title_downshift
      );
      //Bucket 2 box info
      ctx.fillStyle = "grey";
      ctx.fillRect(
      ...
      ctx.fillRect(
        ...
        row_y2_start,
        x_width + row_x1_start,
        y_width + row_y2_start
      );
      ctx.fillStyle = "black";
      ctx.fillText(
        "Bucket 5:",
        row_x1_start + title_indent,
        row_y2_start + title_downshift
      );
      //Bucket 6 box info
      ctx.fillStyle = "grey";
      ctx.fillRect(
...
function change_process() {
  loadScreen("change_process.html", function () {
    document.body.style.backgroundColor = "lightgrey";
